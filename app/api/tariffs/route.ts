      ...
      await db.insert(systemTariffs).values([
        {
          id: 'tariff-daily',
          name: 'Kunlik Sinov',
          description: '1 kunlik to‘liq sinov, avto-to‘lov va guruhlar monitoringi',
          features: JSON.stringify([
            '⚡️ @CardXabarBot & @humocardbot orqali 1 soniyada avto-to‘lov',
            '👥 1 ta VIP Guruhda Majburiy To‘lov (10 tagacha faol a’zo)',
            '🏪 3 tagacha do‘kon ochish va kartalarga ulash',
            '🔗 Har bir do‘kon uchun alohida Webhook & Kanal',
            '🎁 1 ta Donate / Ehson yig‘ish kampaniyasi',
            '0% komissiya, mablag‘ to‘g‘ridan-to‘g‘ri shaxsiy kartangizga',
            '📄 PDF cheklar va kvitansiyalar generatsiyasi',
          ]),
          price: 5000,
          period: 'kun',
          cardNumber: '9860350123453587',
          cardOwner: 'Sardor Tuyginov',
          cardBank: 'HUMO / UZCARD',
          active: true,
        },
        {
          id: 'tariff-weekly',
          name: 'Haftalik Standart',
          description: '7 kunlik biznes, do‘konlar va guruhlar avtomatizatsiyasi',
          features: JSON.stringify([
            '⚡️ 1 soniyada avto-to‘lov tasdiqlash (@humocardbot & @CardXabarBot)',
            '👥 5 tagacha VIP Guruh / Kanal (500 tagacha pullik a’zo va avto-ruxsat)',
            '🏪 10 tagacha mustaqil do‘konlar va individual Webhooklar',
            '🤖 Avtomatik guruh a’zolarini monitoring qilish va muddat tugaganda avto-mute',
        ...
        },
        {
          ...
          features: JSON.stringify([
            '👑 CHEKSIZ Guruhlar va Kanallar uchun Majburiy To‘lov tizimi',
            '⚡️ CHEKSIZ pullik a’zolar, 1 soniyada avto-ruxsat va avto-kick (mute/unmute)',
            '🏪 CHEKSIZ do‘konlar ochish va har biriga alohida HUMO/UZCARD karta ulash',
            '🔗 Har bir guruh va do‘konga individual Webhook & bildirishnoma kanali',
            '🎁 CHEKSIZ Donate / Ehson yig‘ish kampaniyalari',
            '💳 Har bir do‘kon va guruhga alohida shaxsiy karta bog‘lash',
            '0% komissiya — 100% tushumlar to‘g‘ridan-to‘g‘ri kartangizga',
            '📄 Brendlangan PDF cheklar va to‘lov tahlillari',
            '🚀 24/7 VIP ustuvorlikdagi texnik qo‘llab-quvvatlash va konsultant',
          ]),
          price: 79000,
          period: 'oy',
          cardNumber: '9860350123453587',
